  ...
  <div class="overlay" @click.self="$emit('close')">
    <div class="modal">
      ...
      <div class="fg">
        ...
        <div class="job-types">
          <button class="jt-btn" :class="{ sel: form.jobType === 'haircut' }"     @click="form.jobType = 'haircut'">Haircut</button>
        </div>
      ...
      <div class="fg">
        ...
        <input class="fi" type="number" v-model="form.rate" placeholder="e.g. 100" min="1" inputmode="decimal" />
